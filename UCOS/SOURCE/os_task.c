...
INT8U  OSTaskCreate (void   (*task)(void *p_arg),
                     void    *p_arg,
                     OS_STK  *ptos,
                     INT8U    prio, INT16U c,INT16U t,INT16U deadline)/*自己添加了执行时间和周期*/
{
    OS_STK    *psp;
    INT8U      err;
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        err = OS_TCBInit(prio, psp, (OS_STK *)0, 0u, 0u, (void *)0, 0u,c,t,deadline);
        if (err == OS_ERR_NONE) {
                        ...
                        INT16U   opt)
{
    ...
    if (OSTCBPrioTbl[prio] == (OS_TCB *)0) { /* Make sure task doesn't already exist at this priority  */
        ...
        err = OS_TCBInit(prio, psp, pbos, id, stk_size, pext, opt,0u,0u,0xffff);
        if (err == OS_ERR_NONE) {
